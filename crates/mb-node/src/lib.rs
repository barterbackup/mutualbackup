...
pub use network::{
    ...
    TorTransport, TorTransportConfig, build_p2p, build_p2p_with_tor, endpoint_record_key,
    is_onion_address, onion_address_matches_node, onion_address_matches_peer,

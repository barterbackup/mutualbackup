...
impl Mapping {
    ...
    pub async fn new(
        ...
        // Resolve the public address before requesting the lease. Once a
        // successful mapping response arrives, construction must not suspend
        // again or cancellation could strand the granted lease without a
        // `Mapping` value that can release it.
